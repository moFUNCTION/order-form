  ...
  return (
    <Accordion allowToggle>
      <AccordionItem>
        {({ isExpanded }) => {
          setValue(
            "PCB_Specification_Selection.useCustomizesServicesAndAdvancedOption",
            isExpanded
          );
          return (
            <>
              ...
              <AccordionPanel overflow="unset" as={Stack} gap="5" pb={4}>
                ...
                <Flex flexWrap="wrap" alignItems="center" gap="3">
                  <Flex gap="3">
                    <TextWithPopOver
                      flexShrink="0"
                      title="Peelable soldermask : "
                    >
                      Also known as a blue peelable mask, it is used to protect
                      the required solder pads during assembly and is typically
                      referred to as GTPM and GBPM in design. Unlike green
                      soldermask, which is a negative image and is permanently
                      present on the PCB in PCB design, Peelable Soldermask is a
                      positive image (what you see is what you get in your
                      design) and is temporarily used for PCB manufacturing and
                      assembly. Coating material could be removed after board
                ...
                <Flex flexWrap="wrap" gap="5" alignItems="center">
                  <Flex gap="3" alignItems="center">
                    <TextWithPopOver flexShrink="0" title="UL marking:">
                      PCBWay has obtained UL certification, please choose to add
                      the corresponding logo on the layer you need. We will add
                      the logo JDB-D if it is a two-layer board, and add JDB-M
                      if it is a multilayer board.For single layer metal base
                      PCB,we will add corresponding UL（JDB-A1,JDB-A2,JDB-A3 as
                      required.
                      <Image src={ULMarketingImage} w="100%" />
                    </TextWithPopOver>
                    <Image
                      src={ULMarketingImage2}
                      w="30px"
                      objectFit="contain"
                    />
