    ...
    <Stack>
      ...
      <Stack gap="6" p="4">
        ...
        <Text borderRadius="md" size="sm" p="4" bgColor="blue.50">
          ...
          review or contact Service@pcbway.com for help. Need a quick and
          accurante quote? Need an efficient production? Please read SMT
          Ordering Necessary Files & Info in 1 minute. Thank you very much!
        </Text>
      </Stack>
    </Stack>
  );
